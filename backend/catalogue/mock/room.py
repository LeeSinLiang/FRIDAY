...
MOCK_ROOM: dict = {
    ...
    "walls": [
        {"id": "w-n", "a": [0, 3600], "b": [4200, 3600], "height_mm": 2400},
        {"id": "w-e", "a": [4200, 3600], "b": [4200, 0], "height_mm": 2400},
        {"id": "w-s", "a": [4200, 0], "b": [0, 0], "height_mm": 2400},
        {"id": "w-w", "a": [0, 0], "b": [0, 3600], "height_mm": 2400},
    ],
    "openings": [
...
def room_refs(room: dict) -> dict[str, list[dict]]:
    ...
    return {
        "walls": [{"id": wall["id"]} for wall in room["walls"]],
