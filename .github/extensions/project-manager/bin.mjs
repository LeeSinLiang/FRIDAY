...
// the optional canvas host. Teammates can run it from Codex, CI,
// or a normal terminal and open it in a browser:
//
//   node .github/extensions/project-manager/bin.mjs
//
// This shares board.mjs and server.mjs with the canvas extension and reads
// the same data/board.json, so this view and any canvas panels stay in
...
async function main() {
    ...
    console.log("Reading/writing data/board.json — shared with Codex task updates and local panels.");
