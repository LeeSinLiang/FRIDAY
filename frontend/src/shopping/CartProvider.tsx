...
export type CartItem = { id: string; roomId: string; instanceId: string; product_id: string; name: string; unit_amount: number; priced: boolean; vendor: { id: string; name: string } | null; thumbnail: string; available: boolean }
