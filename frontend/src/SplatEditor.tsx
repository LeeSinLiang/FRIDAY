...
export default function SplatEditor({roomId, shopping = false}:{roomId?:string; shopping?:boolean}) {
  ...
  const state:InteractionState|null=useMemo(()=>room?({room,products,instances,selectedId,pendingProductId,editingEnabled:ready,snap,mode,view,retries,showSurface}):null,
    [room,products,instances,selectedId,pendingProductId,ready,snap,mode,view,retries,showSurface]);
