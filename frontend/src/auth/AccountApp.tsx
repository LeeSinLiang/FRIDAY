...
function AccountContent() {
  ...
  const steps = onboarding ? ['Create account', 'Verify email', 'Set up authenticator'] : ['Sign in', 'Enter authenticator code', 'Review your cart']
  ...
  else if (step === 'ready') content = <CartReady/>
  else content = <AccountPages step={step} />

  return <div className="account-app shopping-account">
    ...
    <main className="account-layout"><aside>
      <CartSummary editable={step !== 'checkout'}/>
